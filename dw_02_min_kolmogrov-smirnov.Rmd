...
To prove that the stimuli are well-matched face width, here is what the distribution of `face_width` looks like for each condition:
...
```{r}
# sort ascendingly (largest K-S statistic first), and extract the top seed
